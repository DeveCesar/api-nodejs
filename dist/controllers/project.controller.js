...
function _createProject() {
  ...
  regeneratorRuntime.mark(function _callee3(req, res) {
    var _req$body, nombre, prioridad, descripcion, fecha, newProject;

    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _req$body = req.body, nombre = _req$body.nombre, prioridad = _req$body.prioridad, descripcion = _req$body.descripcion, fecha = _req$body.fecha;
            _context3.prev = 1;
            _context3.next = 4;
          ...
          case 9:
            ...
            return _context3.abrupt("return", res.status(500).json({
              message: "Hubo un error al crear tu proyecto.. Lo estamos solucionando",
              data: {}
            }));
...
function _updateProject() {
  ...
  regeneratorRuntime.mark(function _callee6(req, res) {
    var id, _req$body2, nombre, prioridad, descripcion, fecha, projects;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.prev = 0;
            id = req.params.id;
            _req$body2 = req.body, nombre = _req$body2.nombre, prioridad = _req$body2.prioridad, descripcion = _req$body2.descripcion, fecha = _req$body2.fecha;
            _context6.next = 5;
            return _Project["default"].findAll({
